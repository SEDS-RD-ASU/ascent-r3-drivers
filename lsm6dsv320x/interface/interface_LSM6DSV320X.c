...
static esp_err_t lsm_transform(lsm_raw_data_t* data){
    ...
    float transformed_lowacc_y = (0.707106f * data->lowacc_x) - (0.707106f * data->lowacc_y);

    float transformed_highacc_x = (-0.707106f * data->highacc_x) - (0.707106f * data->highacc_y);
    float transformed_highacc_y = (0.707106f * data->highacc_x) - (0.707106f * data->highacc_y);
